...
//!
//! Without Hyphae: agent has no memory of session 1 → must guess or say "I don't know".
//! With Hyphae: agent stored facts in session 1 → can recall and answer accurately.
