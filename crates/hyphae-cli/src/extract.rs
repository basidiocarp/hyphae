...
/// Maximum number of candidate facts before deduplication.
const DEFAULT_PRE_DEDUP_LIMIT: usize = 30;
...
fn extract_facts(text: &str, project: &str) -> Vec<(String, String, Importance)> {
    ...
    scored.truncate(DEFAULT_PRE_DEDUP_LIMIT);
    ...
    facts.truncate(DEFAULT_MAX_FACTS);
    facts
}
